...
;; astro-ts-mode's generated autoloads call `treesit-ready-p' (from treesit.el)
;; during the package-autoloads phase of startup, which runs long before
;; config.el. Load treesit here — init.el is evaluated early enough — so that
;; function is defined and Doom doesn't abort booting.
(require 'treesit)
